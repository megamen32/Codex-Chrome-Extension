var background = (function () {
  var Ut = Object.defineProperty,
    we = (t, e) => {
      let a = {};
      for (var s in t) Ut(a, s, { get: t[s], enumerable: !0 });
  ...
  function Zt(t) {
    ...
    switch (t) {
      ...
      default:
        throw new Error(
          `Unsupported extension build channel "${t}". Use "dev", "internal", or "prod".`,
        );
    }
  }
  var K = class {
  ...
  (function (t) {
    ...
    ((t.assertNever = a),
      ...
      (t.getValidEnumValues = (r) => {
        const i = t.objectKeys(r).filter((d) => typeof r[r[d]] != "number"),
          o = {};
        for (const d of i) o[d] = r[d];
        return t.objectValues(o);
      }),
      (t.objectValues = (r) =>
        t.objectKeys(r).map(function (i) {
          return r[i];
        })),
      (t.objectKeys =
  ...
  var tt = (t) => {
    const { data: e, path: a, errorMaps: s, issueData: r } = t,
      i = [...a, ...(r.path || [])],
      o = { ...r, path: i };
  ...
  var U = class Da {
    ...
    T = Object.freeze({ status: "aborted" }),
    he = (t) => ({ status: "dirty", value: t }),
    B = (t) => ({ status: "valid", value: t }),
    jt = (t) => t.status === "aborted",
    Dt = (t) => t.status === "dirty",
    ne = (t) => t.status === "valid",
    _e = (t) => typeof Promise < "u" && t instanceof Promise,
    w;
  (function (t) {
  ...
  var C = class {
        ...
        if (!this["~standard"].async)
          try {
            ...
            (a?.message?.toLowerCase()?.includes("encountered") &&
              ...
              (e.common = { issues: [], async: !0 }));
          }
        return this._parseAsync({ data: t, path: [], parent: e }).then((a) =>
          ne(a) ? { value: a.value } : { issues: e.common.issues },
        );
      }
      ...
      async safeParseAsync(t, e) {
        const a = {
            common: { issues: [], contextualErrorMap: e?.errorMap, async: !0 },
            path: e?.path || [],
            schemaErrorMap: this._def.errorMap,
            parent: null,
            data: t,
      ...
      refine(t, e) {
        ...
        return this._refinement((s, r) => {
          const i = t(s),
            o = () => r.addIssue({ code: h.custom, ...a(s) });
      ...
      refinement(t, e) {
        return this._refinement((a, s) =>
          t(a) ? !0 : (s.addIssue(typeof e == "function" ? e(a, s) : e), !1),
        );
      }
      _refinement(t) {
        return new W({
    ...
    Qa = /^c[^\s-]{8,}$/i,
    Ya = /^[0-9a-z]+$/,
    Xa = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
    Ja =
      /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
    es = /^[a-z0-9_-]{21}$/i,
    ts = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
    as =
              ...
              : r.kind === "multipleOf"
                ...
                : r.kind === "finite"
                  ? Number.isFinite(e.data) ||
                    ((a = this._getOrReturnCtx(e, a)),
                    p(a, { code: h.not_finite, message: r.message }),
                    s.dirty())
                  : A.assertNever(r);
      return { status: s.value, value: e.data };
    }
    gte(e, a) {
      return this.setLimit("min", e, !0, w.toString(a));
    }
    gt(e, a) {
      return this.setLimit("min", e, !1, w.toString(a));
    }
    lte(e, a) {
      return this.setLimit("max", e, !0, w.toString(a));
    }
    lt(e, a) {
      return this.setLimit("max", e, !1, w.toString(a));
    }
    setLimit(e, a, s, r) {
      return new $t({
        ...this._def,
        checks: [
          ...this._def.checks,
          { kind: e, value: a, inclusive: s, message: w.toString(r) },
        ],
      });
    }
    _addCheck(e) {
  ...
  nt.create = (t) =>
    new nt({ typeName: S.ZodBoolean, coerce: t?.coerce || !1, ...x(t) });
  var it = class za extends C {
    _parse(e) {
      ...
      if (Number.isNaN(e.data.getTime()))
        return (p(this._getOrReturnCtx(e), { code: h.invalid_date }), T);
      const a = new U();
      let s;
      for (const r of this._def.checks)
        r.kind === "min"
  ...
  var oe = class Xe extends C {
    _parse(e) {
      const { ctx: a, status: s } = this._processInputParams(e),
        r = this._def;
      ...
      if (r.exactLength !== null) {
        const o = a.data.length > r.exactLength.value,
          d = a.data.length < r.exactLength.value;
        (o || d) &&
          (p(a, {
      ...
      if (
        ...
        return Promise.all(
          [...a.data].map((o, d) => r.type._parseAsync(new V(a, o, a.path, d))),
        ).then((o) => U.mergeArray(s, o));
      const i = [...a.data].map((o, d) =>
        r.type._parseSync(new V(a, o, a.path, d)),
      );
    ...
    min(e, a) {
      return new Xe({
        ...this._def,
        minLength: { value: e, message: w.toString(a) },
      });
    }
    max(e, a) {
      return new Xe({
        ...this._def,
        maxLength: { value: e, message: w.toString(a) },
      });
    }
    length(e, a) {
      return new Xe({
        ...this._def,
        exactLength: { value: e, message: w.toString(a) },
      });
    }
    nonempty(e) {
      return this.min(1, e);
  ...
  function ce(t) {
    if (t instanceof j) {
      ...
      return t instanceof oe
        ? new oe({ ...t._def, type: ce(t.element) })
        : t instanceof H
          ? H.create(ce(t.unwrap()))
          : t instanceof ae
            ? ae.create(ce(t.unwrap()))
            : t instanceof te
              ? te.create(t.items.map((e) => ce(e)))
              : t;
  }
  var j = class z extends C {
    ...
    _parse(e) {
      ...
      const { status: a, ctx: s } = this._processInputParams(e),
        ...
        o = [];
      if (
        !(this._def.catchall instanceof Y && this._def.unknownKeys === "strip")
      )
        for (const u in s.data) i.includes(u) || o.push(u);
      const d = [];
      for (const u of i) {
        const l = r[u],
          _ = s.data[u];
        d.push({
          ...
          value: l._parse(new V(s, _, s.path, u)),
      ...
      if (this._def.catchall instanceof Y) {
        ...
        if (u === "passthrough")
          ...
          o.length > 0 &&
            (p(s, { code: h.unrecognized_keys, keys: o }), a.dirty());
        else if (u !== "strip")
          throw new Error(
        ...
        for (const l of o) {
          ...
          d.push({
            key: { status: "valid", value: l },
            value: u._parse(new V(s, _, s.path, l)),
      ...
      return s.common.async
        ? Promise.resolve()
            ...
            .then((u) => U.mergeObjectSync(a, u))
        : U.mergeObjectSync(a, d);
    }
    get shape() {
        ...
        new z({
          ...
          ...(e !== void 0
            ? {
                errorMap: (a, s) => {
                  const r =
                    this._def.errorMap?.(a, s).message ?? s.defaultError;
                  return a.code === "unrecognized_keys"
                    ? { message: w.errToObj(e).message ?? r }
                    : { message: r };
                },
              }
            : {}),
  ...
  var xe = class extends C {
    _parse(t) {
        ...
        ).then(s);
      {
        ...
        const i = [];
        for (const d of a) {
          const u = { ...e, common: { ...e.common, issues: [] }, parent: null },
            l = d._parseSync({ data: e.data, path: e.path, parent: u });
          if (l.status === "valid") return l;
          (l.status === "dirty" && !r && (r = { result: l, ctx: u }),
                  ...
                  : t instanceof Se
                    ...
                    : t instanceof Ie
                      ...
                      : t instanceof H
                        ...
                        : t instanceof ae
                          ? [null, ...G(t.unwrap())]
                          : t instanceof Wt || t instanceof $e
                            ? G(t.unwrap())
                            : t instanceof Me
                              ? G(t._def.innerType)
                              : [],
    ys = class qa extends C {
      _parse(e) {
        ...
        return i
          ? a.common.async
            ? i._parseAsync({ data: a.data, path: a.path, parent: a })
            : i._parseSync({ data: a.data, path: a.path, parent: a })
          : (p(a, {
      ...
      static create(e, a, s) {
        ...
        for (const i of a) {
          ...
          for (const d of o) {
            if (r.has(d))
              throw new Error(
                `Discriminator property ${String(e)} has duplicate value ${String(d)}`,
              );
            r.set(d, i);
          }
        }
  ...
  function ut(t, e) {
    ...
    if (a === y.object && s === y.object) {
      const r = A.objectKeys(e),
        i = A.objectKeys(t).filter((d) => r.indexOf(d) !== -1),
        o = { ...t, ...e };
      for (const d of i) {
        const u = ut(t[d], e[d]);
      ...
      const { status: e, ctx: a } = this._processInputParams(t),
        s = (r, i) => {
          ...
          return o.valid
            ...
            : (p(a, { code: h.invalid_intersection_types }), T);
        };
  ...
  ke.create = (t, e, a) =>
    new ke({ left: t, right: e, typeName: S.ZodIntersection, ...x(a) });
  var te = class Va extends C {
    _parse(e) {
      ...
      const r = [...s.data]
        ...
        .filter((i) => !!i);
      return s.common.async
        ? Promise.all(r).then((i) => U.mergeArray(a, i))
        : U.mergeArray(a, r);
    }
    get items() {
  ...
  var bs = class Lt extends C {
      ...
      _parse(e) {
        ...
        for (const d in s.data)
          r.push({
            key: i._parse(new V(s, d, s.path, d)),
            value: o._parse(new V(s, s.data[d], s.path, d)),
            alwaysSet: d in s.data,
          });
        return s.common.async
          ? U.mergeObjectAsync(a, r)
          : U.mergeObjectSync(a, r);
      }
      get element() {
        return this._def.valueType;
      }
      static create(e, a, s) {
        return a instanceof C
          ? new Lt({ keyType: e, valueType: a, typeName: S.ZodRecord, ...x(s) })
          : new Lt({
              keyType: Te.create(),
              valueType: e,
    ...
    lt = class extends C {
      ...
      _parse(t) {
        ...
        const s = this._def.keyType,
          ...
          i = [...a.data.entries()].map(([o, d], u) => ({
            key: s._parse(new V(a, o, a.path, [u, "key"])),
            value: r._parse(new V(a, d, a.path, [u, "value"])),
          }));
        if (a.common.async) {
          const o = new Map();
          return Promise.resolve().then(async () => {
            for (const d of i) {
              ...
              ((u.status === "dirty" || l.status === "dirty") && e.dirty(),
  ...
  lt.create = (t, e, a) =>
    new lt({ valueType: e, keyType: t, typeName: S.ZodMap, ...x(a) });
  var ht = class Nt extends C {
    _parse(e) {
      ...
      const d = [...s.data.values()].map((u, l) =>
        i._parse(new V(s, u, s.path, l)),
      );
    ...
    min(e, a) {
      return new Nt({
        ...this._def,
        minSize: { value: e, message: w.toString(a) },
      });
    }
    max(e, a) {
      return new Nt({
        ...this._def,
        maxSize: { value: e, message: w.toString(a) },
      });
    }
    size(e, a) {
  ...
  var ws = class Je extends C {
      ...
      _parse(e) {
        ...
        const i = { errorMap: a.common.contextualErrorMap },
          o = a.data;
        if (this._def.returns instanceof fe) {
          const d = this;
          return B(async function (...u) {
            const l = new q([]),
              _ = await d._def.args.parseAsync(u, i).catch((J) => {
                throw (l.addIssue(s(u, J)), l);
              }),
              P = await Reflect.apply(o, this, _);
            return await d._def.returns._def.type
              .parseAsync(P, i)
              .catch((J) => {
          ...
          return B(function (...u) {
            ...
            const _ = Reflect.apply(o, this, l.data),
              P = d._def.returns.safeParse(_, i);
      ...
      static create(e, a, s) {
        return new Je({
          args: e || te.create([]).rest(ie.create()),
          returns: a || ie.create(),
    ...
    _parse(e) {
      ...
      if (
        ...
        const a = this._getOrReturnCtx(e),
          s = this._def.values;
        return (
          p(a, { received: a.data, code: h.invalid_enum_value, options: s }),
          T
        );
      }
      return B(e.data);
  ...
  var Pe = class extends C {
    _parse(t) {
      const e = A.getValidEnumValues(this._def.values),
  ...
  Pe.create = (t, e) =>
    new Pe({ values: t, typeName: S.ZodNativeEnum, ...x(e) });
  var fe = class extends C {
    ...
    _parse(t) {
      const { ctx: e } = this._processInputParams(t);
      return e.parsedType !== y.promise && e.common.async === !1
        ? (p(e, {
            code: h.invalid_type,
            expected: y.promise,
            received: e.parsedType,
          ...
          return this._def.schema
            ...
            .then((o) =>
              o.status === "aborted"
                ? T
                : (o.status === "dirty" && e.dirty(),
                  i(o.value).then(() => ({ status: e.value, value: o.value }))),
            );
      }
      if (s.type === "transform")
        if (a.common.async === !1) {
          ...
          return this._def.schema
            ...
            .then((i) =>
              ne(i)
                ? Promise.resolve(s.transform(i.value, r)).then((o) => ({
                    status: e.value,
                    value: o,
                  }))
                : T,
  ...
  ((W.create = (t, e, a) =>
    new W({ schema: t, typeName: S.ZodEffects, effect: e, ...x(a) })),
    (W.createWithPreprocess = (t, e, a) =>
      new W({
        schema: e,
  ...
  H.create = (t, e) =>
    new H({ innerType: t, typeName: S.ZodOptional, ...x(e) });
  var ae = class extends C {
    _parse(t) {
  ...
  ae.create = (t, e) =>
    new ae({ innerType: t, typeName: S.ZodNullable, ...x(e) });
  var Ee = class extends C {
    _parse(t) {
      const { ctx: e } = this._processInputParams(t);
      let a = e.data;
      return (
        e.parsedType === y.undefined && (a = this._def.defaultValue()),
        this._def.innerType._parse({ data: a, path: e.path, parent: e })
      );
    }
    removeDefault() {
      return this._def.innerType;
      ...
      _parse(e) {
          ...
          })();
        {
          ...
          return r.status === "aborted"
            ? T
            : r.status === "dirty"
              ? (a.dirty(), { status: "dirty", value: r.value })
    ...
    $e = class extends C {
      _parse(t) {
        const e = this._def.innerType._parse(t),
          a = (s) => (ne(s) && (s.value = Object.freeze(s.value)), s);
  ...
  $e.create = (t, e) =>
    new $e({ innerType: t, typeName: S.ZodReadonly, ...x(e) });
  var ci = { object: j.lazycreate },
    S;
  (function (t) {
  ...
  var n = Te.create,
    ...
    Ei = H.create,
    Mi = ae.create,
    $i = W.createWithPreprocess,
    Oi = Ht.create,
    Li = c({ browser_id: n() }),
    Ni = c({ id: n() }),
    Bi = c({ browser_id: n(), tab_id: n() }),
    Ui = c({}),
    _s = O(["handoff", "deliverable"]),
    Zi = c({
      browser_id: n(),
      keep: k(c({ tab_id: n(), status: _s })).optional(),
    }),
    Fi = c({}),
    ji = c({ browser_id: n() }),
    Di = c({ display_truncate_max_chars: b().int().positive().optional() }),
    zi = c({ browser_id: n(), name: n() }),
    qi = c({}),
    Vi = c({ browser_id: n() }),
    Gi = c({ id: n().optional() }),
    Wi = c({ browser_id: n() }),
    Hi = c({
      tabs: k(c({ id: n(), url: n().optional(), title: n().optional() })),
    }),
    Ts = O(["html", "text", "domSnapshot"]),
    Ki = c({
      browser_id: n(),
      urls: k(n()),
      content_type: Ts,
      timeout_ms: b().int().positive().optional(),
    }),
    Qi = c({
      results: k(
        c({ url: n(), title: n().nullable(), content: n().nullable() }),
      ),
    }),
    Ss = c({
      readOnlyHint: L().optional(),
      untrustedContentHint: L().optional(),
    }),
    Is = c({
      name: n(),
      title: n().optional(),
      ...
      input_schema: me(),
      annotations: Ss.optional(),
      origin: n().optional(),
      pageUrl: n().optional(),
    }),
    xs = c({ browser_id: n(), tab_id: n() }),
    Yi = c({ tools: k(Is) }),
    ks = "webmcp_list_tools";
  function Cs(t) {
  ...
  var As = c({
    ...
    Xi = c({ result: me() }),
    Rs = "webmcp_invoke_tool";
  function Ps(t) {
    return new K(Rs, As, t);
  }
  var Ji = c({ browser_id: n(), tab_id: n(), url: n() }),
    eo = c({}),
    to = c({ browser_id: n(), tab_id: n() }),
    ao = c({}),
    so = c({ browser_id: n(), tab_id: n() }),
    ro = c({}),
    no = c({ browser_id: n(), tab_id: n() }),
    io = c({}),
    oo = c({ browser_id: n(), tab_id: n() }),
    co = c({ id: n(), title: n().optional(), url: n().optional() }),
    uo = c({ browser_id: n() }),
    lo = c({
      tabs: k(
        c({
    ...
    ho = c({
      browser_id: n(),
      query: n().optional(),
      limit: b().int().positive().optional(),
      from: n().optional(),
      to: n().optional(),
    }),
    fo = c({
      items: k(c({ url: n(), title: n().optional(), dateVisited: n() })),
    }),
    Qt = O(["debug", "info", "log", "warn", "error"]),
    mo = c({
      browser_id: n(),
      tab_id: n(),
      filter: n().optional(),
      levels: k(Qt).optional(),
      limit: b().int().positive().optional(),
    }),
    po = c({
      logs: k(
        c({ level: Qt, message: n(), timestamp: n(), url: n().optional() }),
      ),
    }),
    vo = c({ browser_id: n(), tab_id: n() }),
    go = c({ path: n() }),
    Es = O(["pdf", "md", "xlsx", "csv", "docx", "pptx"]),
    yo = c({ browser_id: n(), tab_id: n(), format: Es }),
    bo = c({ path: n() }),
    wo = c({ browser_id: n(), tab_id: n() }),
    _o = c({ text: n() }),
    To = c({ browser_id: n(), tab_id: n(), text: n() }),
    So = c({}),
    Ms = c({
      mime_type: n(),
      text: n().optional(),
    ...
    $s = c({
      entries: k(Ms),
      presentation_style: O(["unspecified", "inline", "attachment"]).optional(),
    }),
    Io = c({ browser_id: n(), tab_id: n() }),
    xo = c({ items: k($s) }),
    Os = c({
      mime_type: n(),
      text: n().optional(),
    ...
    ko = c({ browser_id: n(), tab_id: n(), items: k(Ls) }),
    Co = c({}),
    Ao = c({
      browser_id: n(),
      tab_id: n(),
      ...
      cropX: b().optional(),
      cropY: b().optional(),
      cropWidth: b().optional(),
      cropHeight: b().optional(),
    }),
    Ro = c({ data: n() }),
    Po = c({
      browser_id: n(),
    ...
    Bo = c({}),
    Uo = c({ browser_id: n(), tab_id: n(), keys: k(n()) }),
    Zo = c({}),
    Fo = c({
      browser_id: n(),
      tab_id: n(),
    ...
    Vo = c({}),
    Go = c({ browser_id: n(), tab_id: n(), text: n() }),
    Wo = c({}),
    Ho = c({ browser_id: n(), tab_id: n(), node_id: n() }),
    Ko = c({}),
    Qo = c({
      browser_id: n(),
      tab_id: n(),
    ...
    Yo = c({}),
    Xo = c({ browser_id: n(), tab_id: n(), node_id: n() }),
    Jo = c({}),
    ec = c({ browser_id: n(), tab_id: n() }),
    tc = me(),
    ac = c({ browser_id: n(), tab_id: n(), keys: k(n()) }),
    sc = c({}),
    rc = c({
      browser_id: n(),
      tab_id: n(),
    ...
    nc = c({}),
    ic = c({ browser_id: n(), tab_id: n(), text: n() }),
    oc = c({}),
    cc = c({
      browser_id: n(),
      tab_id: n(),
      selector: n(),
      modifiers: k(
        O(["Alt", "Control", "ControlOrMeta", "Meta", "Shift"]),
      ).optional(),
      button: O(["left", "right", "middle"]).optional(),
      force: L().optional(),
      timeout_ms: b().int().positive().optional(),
    }),
    dc = c({}),
    ...
    pc = c({}),
    vc = c({ browser_id: n(), tab_id: n(), selector: n(), value: n() }),
    gc = c({}),
    yc = c({
      browser_id: n(),
      tab_id: n(),
      selector: n(),
      state: O(["attached", "detached", "visible", "hidden"]),
      timeout_ms: b().int().positive().optional(),
    }),
    bc = c({}),
    wc = c({ browser_id: n(), tab_id: n(), selector: n() }),
    _c = c({ count: b().int() }),
    Ns = c({
      value: n().optional(),
      label: n().optional(),
      index: b().int().nonnegative().optional(),
    }).superRefine((t, e) => {
      t.value === void 0 &&
        t.label === void 0 &&
        t.index === void 0 &&
    ...
    xc = c({}),
    kc = c({ browser_id: n(), tab_id: n(), selector: n() }),
    Cc = c({ value: L() }),
    Ac = c({ browser_id: n(), tab_id: n(), selector: n() }),
    Rc = c({ value: L() }),
    Pc = c({
      browser_id: n(),
      tab_id: n(),
    ...
    Bc = c({ value: n().nullable() }),
    Uc = c({
      browser_id: n(),
      tab_id: n(),
      selector: n(),
      relative_selector: n().optional(),
      timeout_ms: b().int().positive().optional(),
    }),
    Bs = c({
      attributes: Kt(n()),
      inner_text: n(),
      text_content: n().nullable(),
    }),
    Zc = c({ values: k(Bs.nullable()) }),
    Us = O(["load", "domcontentloaded", "networkidle", "commit"]),
    Fc = c({
      browser_id: n(),
      tab_id: n(),
      url: n(),
      wait_until: Us.optional(),
      timeout_ms: b().int().positive().optional(),
    }),
    jc = c({ url: n().optional() }),
    Zs = O(["load", "domcontentloaded", "networkidle"]),
    Dc = c({
      browser_id: n(),
      tab_id: n(),
      state: Zs.optional(),
    ...
    qc = c({
      browser_id: n(),
      tab_id: n(),
      timeout_ms: b().int().nonnegative(),
    }),
    Vc = c({}),
    Gc = c({ browser_id: n(), tab_id: n() }),
    Wc = c({ dom_snapshot: n() }),
    Fs = c({ x: b(), y: b(), width: b(), height: b() }),
    js = c({
      primary: n().nullable().optional(),
      candidates: k(n()),
      frameSelectors: k(n()).optional(),
    }),
    Ds = c({
      nodeId: b().int().positive().nullable().optional(),
      tagName: n(),
      role: n().nullable().optional(),
      visibleText: n().nullable().optional(),
      ariaName: n().nullable().optional(),
      testId: n().nullable().optional(),
      boundingBox: Fs.nullable().optional(),
      preview: n(),
      selector: js,
    }),
    Hc = c({
      ...
      x: b(),
      y: b(),
      include_non_interactable: L().optional(),
    }),
    Kc = k(Ds),
    Qc = c({
      browser_id: n(),
    ...
    td = c({ path: n().nullable() }),
    ad = c({
      browser_id: n(),
      tab_id: n(),
      timeout_ms: b().int().positive().optional(),
    }),
    sd = c({ file_chooser_id: n(), is_multiple: L() }),
    rd = c({
      browser_id: n(),
      tab_id: n(),
      file_chooser_id: n(),
  ...
  var ta = O(["font", "image", "script", "stylesheet", "video", "other"]),
    aa = O(["font", "image", "stylesheet", "video"]),
    zs = c({
      kind: O(["attribute", "computedStyle", "resource"]),
      nodeId: b().int().positive().optional(),
      property: n().optional(),
    }),
    qs = c({ id: n(), kind: ta, name: n(), sources: k(zs), url: n() }),
    Vs = c({ id: n(), markup: n(), name: n() }),
    Gs = c({
      assets: k(qs),
      id: n(),
      inlineSvgs: k(Vs),
      pageUrl: n().nullable(),
      summary: c({
        byKind: Kt(ta, b().int().nonnegative()),
        inlineSvgCount: b().int().nonnegative(),
        totalCount: b().int().nonnegative(),
      }),
    }),
    Ws = c({
      assetIds: k(n()).optional(),
      inventoryId: n(),
      kinds: k(aa).optional(),
    }),
    Hs = c({
      contentType: n().nullable(),
      id: n(),
      kind: aa,
      name: n(),
      path: n(),
    ...
    Qs = c({
      ...
      manifestPath: n(),
      summary: c({
        downloadedCount: b().int().nonnegative(),
        elapsedMs: b().nonnegative(),
        failedCount: b().int().nonnegative(),
        requestedCount: b().int().nonnegative(),
      }),
    }),
    Ys = "tab_page_assets_bundle",
    Xs = Ws.extend({ browser_id: n(), tab_id: n() }),
    Js = Qs;
  function er(t) {
    return new K(Ys, Xs, t);
  }
  var tr = "tab_page_assets_list",
    ar = c({ browser_id: n(), tab_id: n() }),
    sr = Gs;
  function rr(t) {
  ...
  var nr = {
    ...
    ir = class extends Xt {
      ...
      async list() {
        const t = await this.transport.send({
          command: rr({ browser_id: this.browserId, tab_id: this.tabId }),
        });
        return sr.parse(t);
      }
      async bundle(t) {
        const e = await this.transport.send({
          command: er({ ...t, browser_id: this.browserId, tab_id: this.tabId }),
        });
        return Js.parse(e);
      }
    },
    or = ea({ capability: ir, info: nr }),
    sa = {
      id: "webmcp",
      description:
    ...
    cr = class extends Xt {
      ...
      async listTools() {
        return (
          await this.transport.send({
            command: Cs({ browser_id: this.browserId, tab_id: this.tabId }),
          })
        ).tools.map((t) => this.toTool(t));
      }
      async invokeTool({ input: t, timeoutMs: e, toolName: a }) {
        const s = a.trim();
        if (!s)
          throw new Error(
            "tab.capabilities.webmcp.invokeTool requires a toolName",
          );
        return (
          await this.transport.send({
            command: Ps({
      ...
      toTool(t) {
        return {
          ...
          ...(t.pageUrl == null ? {} : { pageUrl: t.pageUrl }),
          invoke: async (e, a) =>
  ...
  var hr = we({
    ...
    pt = "browser_visibility_set",
    oa = c({ browser_id: n(), visible: L() }),
    ca = c({});
  function da(t) {
  ...
  var od = { [mt]: lr, [pt]: hr },
    ...
    mr = class extends Yt {
      ...
      async set(t) {
        const e = await this.transport.send({
          command: da({ browser_id: this.browserId, visible: t }),
        });
        ca.parse(e);
      }
      async get() {
        const t = await this.transport.send({
          command: ia({ browser_id: this.browserId }),
        });
        return na.parse(t).visible;
      }
    },
    pr = Jt({ capability: mr, info: fr }),
    vr = we({
      PayloadSchema: () => ua,
      ResultSchema: () => la,
      commandType: () => vt,
  ...
  var gr = we({
    ...
    gt = "browser_viewport_set",
    fa = c({
      browser_id: n(),
      height: b().int().positive(),
      width: b().int().positive(),
    }),
    ma = c({});
  function pa(t) {
  ...
  var cd = { [vt]: vr, [gt]: gr },
    ...
    br = class extends Yt {
      ...
      async set(t) {
        const e = await this.transport.send({
          command: pa({ browser_id: this.browserId, ...t }),
        });
        ma.parse(e);
      }
      async reset() {
        const t = await this.transport.send({
          command: ha({ browser_id: this.browserId }),
        });
        la.parse(t);
      }
    },
    wr = Jt({ capability: br, info: yr }),
    dd = _r([pr, wr]);
  function _r(t) {
    return new Map(t.map((e) => [e.id, e.create]));
  }
  var ud = c({ side_effects: k(n()) }).passthrough(),
    Tr = class {
      nextId = 1;
      ...
      constructor(t) {
        ((this.transport = t),
          this.transport.setMessageCallback((e) => {
            this.handleIncomingMessage(e);
          }),
          this.transport.addCloseListener?.((e) => {
            this.rejectPendingRequests(
              e?.message ?? "transport closed before response",
            );
          }));
      }
      registerRequestHandlerObject(t) {
        [
          ...
          .filter((e) => e !== "constructor" && typeof t[e] == "function")
          .forEach((e) => {
            const a = t[e];
      ...
      async handleIncomingRequest(t) {
        if (t.id === void 0) {
          (this.eventHandlers.get(t.method ?? "") ?? []).forEach((a) =>
            a(t.params),
          );
          return;
        }
        ...
        if (!e) {
          this.transport.sendMessage({
            ...
            error: {
              code: -1,
              message: `No handler registered for method: ${t.method}`,
            },
          });
          return;
        }
    ...
    Sr = class extends Tr {
      constructor(t, e, a = {}) {
        (super(t),
          (this.handler = e),
          (this.options = a),
          this.registerRequestHandlerObject(e),
          this.addEventListener("moveMouse", (s) => {
  ...
  async function bt(t) {
    try {
      return (
        (await Oe(chrome.tabs.sendMessage(t, { type: "CONTENT_PING" })))?.ok ===
        !0
      );
    } catch {
      return !1;
  ...
  var Cr = "codex-favicon-badge",
    ga = { cursor: null, isVisible: !1, sessionId: null, turnId: null };
  function ya(t) {
    if (t == null || !t.startsWith("data:image/svg+xml,")) return !1;
    try {
      return decodeURIComponent(t.slice(19)).includes(
        `data-codex-favicon-badge="${Cr}"`,
      );
    } catch {
      return !1;
    }
  ...
  var Er = class {
      ...
      constructor(t = {}) {
        ((this.observedTabs = t.observedTabs ?? { isObserved: () => !1 }),
          (this.onBrowserControlActivityChanged =
            t.onBrowserControlActivityChanged ?? Rr));
      }
      async startSession(t, e = null, a = {}) {
        const s = this.ensureSession(t);
        (e != null && s.currentTurnId !== e && s.cursorByTabId.clear(),
          (s.currentTurnId = e ?? s.currentTurnId),
          (s.isRunning = !0),
          a.publishTabs !== !1 && (await this.publishSessionTabs(t)),
          this.updateBrowserControlActivity());
      }
      async finishSession(t) {
        const e = this.sessions.get(t);
        e &&
          (await this.publishTabs(this.detachSession(t, e)),
          this.updateBrowserControlActivity());
      }
      isBrowserControlActive() {
        for (const t of this.sessions.values())
          if (t.isRunning || t.activeRequests > 0) return !0;
        return !1;
      }
      setBrowserControlActivityChangeHandler(t) {
        ((this.onBrowserControlActivityChanged = t),
          this.updateBrowserControlActivity());
      }
      ...
      async trackTab(t, e, a = {}) {
        (this.linkTabToSession(t, e),
          a.publish !== !1 && (await this.publishTabState(e)));
      }
      async untrackTab(t, e) {
        const a = this.sessions.get(t);
        (a?.tabIds.delete(e),
          a?.cursorByTabId.delete(e),
          a?.tabIds.size === 0 && this.sessions.delete(t));
        const s = this.tabSessions.get(e);
        (s && (s.delete(t), s.size === 0 && this.tabSessions.delete(e)),
      ...
      async startRequest(t, e) {
        ...
        return (
          (a.activeRequests += 1),
          (!a.abortController || a.abortController.signal.aborted) &&
            (a.abortController = new AbortController()),
          await this.publishSessionTabs(t),
          this.updateBrowserControlActivity(),
      ...
      async finishRequest(t) {
        ...
        e &&
          ...
          e.activeRequests === 0 && (e.abortController = null),
          await this.publishSessionTabs(t),
          this.updateBrowserControlActivity());
      }
      async stopActiveSessions() {
        const t = Array.from(this.sessions.entries())
      ...
      async setCursorState(t, e, a, s, r = {}) {
        ...
        return !i?.isRunning ||
          ((i.currentTurnId = a), i.cursorByTabId.set(e, s), r.publish === !1)
          ? !1
      ...
      readCursorOverlayState(t) {
        ...
        const s = a.cursorByTabId.get(t) ?? null,
          r = this.observedTabs.isObserved(t);
        return {
          cursor: !r && s != null ? { visible: !1, x: s.x, y: s.y } : s,
          isVisible: r,
          sessionId: e,
      ...
      attachTabSession(t, e) {
        ...
        this.tabSessions.set(t, new Set([e]));
      }
      detachSession(t, e) {
      ...
      async publishTabCursorState(t) {
        if (!(await this.prepareContentScript(t))) return !1;
        const e = {
          type: "AGENT_CURSOR_STATE",
          state: this.readCursorOverlayState(t),
        };
        try {
          return (await Oe(chrome.tabs.sendMessage(t, e)))?.ok === !0;
        } catch {
          return !1;
        }
      }
      ...
      updateBrowserControlActivity() {
        ...
        t !== this.lastBrowserControlActive &&
          ((this.lastBrowserControlActive = t),
          this.onBrowserControlActivityChanged(t));
      }
    },
    Mr = class {
      ...
      setActiveTabs(t) {
        ...
        ((this.activeTabIds = e),
          (this.activeTabIdByWindowId = a),
          this.publishChangedTabs(s));
      }
      setWindowActiveTab(t, e) {
        const a = new Set(),
          s = this.activeTabIdByWindowId.get(t);
        (s !== void 0 && s !== e && (this.activeTabIds.delete(s), a.add(s)),
          this.activeTabIdByWindowId.set(t, e),
          this.activeTabIds.has(e) || (this.activeTabIds.add(e), a.add(e)),
          this.publishChangedTabs(a));
      }
  ...
  var wt = new Mr(),
    Z = new Er({ observedTabs: wt });
  wt.setChangeHandler(async (t) => {
    await Z.republishTabStates(t);
  });
  var Le = globalThis.browser?.runtime?.id
      ? globalThis.browser
      : globalThis.chrome,
    Or = new Error("request for lock canceled"),
    Lr = function (t, e, a, s) {
      function r(i) {
    ...
    Nr = class {
      ...
      acquire(t = 1, e = 0) {
        ...
        return new Promise((a, s) => {
          const r = { resolve: a, reject: s, weight: t, priority: e },
            i = wa(this._queue, (o) => e <= o.priority);
          i === -1 && t <= this._value
      ...
      waitForUnlock(t = 1, e = 0) {
        if (t <= 0) throw new Error(`invalid weight ${t}: must be positive`);
        return this._couldLockImmediately(t, e)
          ? Promise.resolve()
          : new Promise((a) => {
              (this._weightedWaiters[t - 1] ||
                (this._weightedWaiters[t - 1] = []),
                Br(this._weightedWaiters[t - 1], { resolve: a, priority: e }));
            });
      }
      isLocked() {
      ...
      _dispatchItem(t) {
        ...
        ((this._value -= t.weight),
          t.resolve([e, this._newReleaser(t.weight)]));
      }
      _newReleaser(t) {
        let e = !1;
        return () => {
      ...
      _couldLockImmediately(t, e) {
        return (
          (this._queue.length === 0 || this._queue[0].priority < e) &&
          t <= this._value
        );
      }
    };
  ...
  function Fr() {
    const t = {
      ...
      i = (m, v) => m ?? v ?? null,
      o = (m) => (typeof m == "object" && !Array.isArray(m) ? m : {}),
      d = async (m, v, f) =>
        i(await m.getItem(v), f?.fallback ?? f?.defaultValue),
      u = async (m, v) => {
        const f = s(v);
    ...
    return {
      ...
      getItems: async (m) => {
        ...
        m.forEach((R) => {
          ...
          (typeof R == "string"
            ? (M = R)
            : "getValue" in R
              ? ((M = R.key), (E = { fallback: R.fallback }))
              : ((M = R.key), (E = R.options)),
            g.push(M));
          const { driverArea: D, driverKey: F } = a(M),
            N = v.get(D) ?? [];
        ...
        return (
          await Promise.all(
            Array.from(v.entries()).map(async ([R, M]) => {
              (await t[R].getItems(M)).forEach((E) => {
                const D = `${R}:${E.key}`,
                  F = f.get(D),
                  N = i(E.value, F?.fallback ?? F?.defaultValue);
                I.set(D, N);
              });
            }),
          ),
      ...
      getMetas: async (m) => {
        const v = m.map((I) => {
            const R = typeof I == "string" ? I : I.key,
              { driverArea: M, driverKey: E } = a(R);
            return { key: R, driverArea: M, driverKey: E, driverMetaKey: s(E) };
          }),
          f = v.reduce(
            (I, R) => ((I[R.driverArea] ??= []), I[R.driverArea].push(R), I),
            {},
          ),
          g = {};
        return (
          await Promise.all(
            Object.entries(f).map(async ([I, R]) => {
      ...
      setItems: async (m) => {
        const v = {};
        (m.forEach((f) => {
          const { driverArea: g, driverKey: I } = a(
            "key" in f ? f.key : f.item.key,
          );
          ((v[g] ??= []), v[g].push({ key: I, value: f.value }));
        }),
          await Promise.all(
            Object.entries(v).map(async ([f, g]) => {
        ...
        (m.forEach((f) => {
          ...
          await Promise.all(
            Object.entries(v).map(async ([f, g]) => {
              const I = e(f),
                R = g.map(({ key: F }) => s(F)),
                M = await I.getItems(R),
                E = Object.fromEntries(
                  M.map(({ key: F, value: N }) => [F, o(N)]),
                ),
                D = g.map(({ key: F, properties: N }) => {
                  const Ke = s(F);
      ...
      defineItem: (m, v) => {
        ...
        const F = async () => {
            const $ = s(g),
              [{ value: ee }, { value: ve }] = await f.getItems([g, $]);
            if (((D = ee == null && ve?.v == null && !!I), ee == null)) return;
            const de = ve?.v ?? 1;
            if (de > I)
              throw Error(
                `Version downgrade detected (v${de} -> v${I}) for "${m}"`,
              );
            if (de === I) return;
            E &&
              console.debug(
                `[@wxt-dev/storage] Running storage migration for ${m}: v${de} -> v${I}`,
              );
            ...
            for (const Ye of oi)
              try {
                ((ue = (await R?.[Ye]?.(ue)) ?? ue),
                  E &&
                    console.debug(
                      `[@wxt-dev/storage] Storage migration processed for version: v${Ye}`,
                    ));
              } catch (Mt) {
            ...
            (await f.setItems([
              ...
              E &&
                console.debug(
                  `[@wxt-dev/storage] Storage migration completed for ${m} v${I}`,
                  { migratedValue: ue },
                ),
              M?.(ue, I));
          },
          N =
            v?.migrations == null
              ...
              : F().catch(($) => {
                  console.error(
                    `[@wxt-dev/storage] Migration failed for ${m}`,
                    $,
                  );
                }),
          Ke = new Zr(),
          Qe = () => v?.fallback ?? v?.defaultValue ?? null,
          Fa = () =>
            Ke.runExclusive(async () => {
              const $ = await f.getItem(g);
              if ($ != null || v?.init == null) return $;
              const ee = await v.init();
              return (
                await f.setItem(g, ee),
                $ == null && I > 1 && (await _(f, g, { v: I })),
                ee
              );
            });
        return (
          N.then(Fa),
          {
            ...
            getValue: async () => (
              await N,
              v?.init ? await Fa() : await d(f, g, v)
            ),
            getMeta: async () => (await N, await u(f, g)),
            setValue: async ($) => {
              (await N,
                D
                  ? ((D = !1),
                    await Promise.all([l(f, g, $), _(f, g, { v: I })]))
                  : await l(f, g, $));
            },
            setMeta: async ($) => (await N, await _(f, g, $)),
            removeValue: async ($) => (await N, await P(f, g, $)),
            removeMeta: async ($) => (await N, await J(f, g, $)),
            watch: ($) => Za(f, g, (ee, ve) => $(ee ?? Qe(), ve ?? Qe())),
            migrate: F,
          }
        );
      },
...
`);
      ...
      a = new Set();
    return {
      getItem: async (s) => (await e().get(s))[s],
      getItems: async (s) => {
      ...
      watch(s, r) {
        const i = (o) => {
          const d = o[s];
          d == null ||
            _t(d.newValue, d.oldValue) ||
            r(d.newValue ?? null, d.oldValue ?? null);
        };
        return (
          e().onChanged.addListener(i),
          a.add(i),
          () => {
  ...
  var jr = class extends Error {
    constructor(t, e, a) {
      (super(`v${e} migration failed for "${t}"`, a),
        (this.key = t),
        (this.version = e));
    }
  };
  ...
  function qr(t) {
    ...
    const e = t;
    return typeof e.tabId != "number" ||
      !Number.isInteger(e.tabId) ||
      typeof e.sessionId != "string" ||
      typeof e.turnId != "string" ||
      !Dr(e.origin) ||
      typeof e.claimedAt != "number" ||
      !Number.isFinite(e.claimedAt) ||
      (e.instanceId !== null && typeof e.instanceId != "string") ||
      !zr(e.state)
      ? null
      : {
          tabId: e.tabId,
          ...
          state: e.state,
          ...(typeof e.groupId == "number" && Number.isInteger(e.groupId)
            ? { groupId: e.groupId }
            : {}),
          ...(typeof e.isActiveHandoff == "boolean"
            ? { isActiveHandoff: e.isActiveHandoff }
            : {}),
        };
  }
  function Vr(t) {
    if (
      ...
      !("leases" in t) ||
      !t.leases ||
      typeof t.leases != "object" ||
      Array.isArray(t.leases)
    )
      return new Map();
    const e = new Map();
  ...
  var Be = class ye {
    ...
    storageLoaded = !1;
    listenersRegistered = !1;
    activeTabLeaseChangeHandlers = new Set();
    handleTabRemoved = (e) => {
      this.removeTab(e);
    };
    ...
    subscribeActiveTabLeaseChanges(e) {
      return (
        this.activeTabLeaseChangeHandlers.add(e),
        () => {
    ...
    async claimTab(e, a, s, r) {
      ...
      await this.mutate(() => {
        ...
        if (o?.state === "active") {
          if (o.sessionId !== e)
            throw new Error(
              `Tab ${s} is already part of browser session ${o.sessionId}`,
            );
          return o.turnId === a && o.instanceId === i
            ? !1
            : (this.leases.set(s, { ...o, turnId: a, instanceId: i }), !0);
        }
        return (
          this.leases.set(s, {
            tabId: s,
    ...
    async getSessionTabs(e) {
      const a = await this.getSessionActiveLeases(e),
        s = await Promise.all(
          [...a.keys()].map(async (o) => {
            try {
              return {
                tab: await chrome.tabs.get(o),
                tabId: o,
                state: "found",
              };
            } catch {
    ...
    async updateActiveSessionTurn(e, a) {
      ...
      await this.mutate(() => {
        let r = !1;
        for (const [i, o] of this.leases.entries())
          o.sessionId !== e ||
            o.state !== "active" ||
            (o.turnId === a && o.instanceId === s) ||
            (this.leases.set(i, { ...o, turnId: a, instanceId: s }), (r = !0));
        return r;
      });
    }
          ...
          for (const u of o) {
            ...
            l?.state !== "active" ||
              ...
              (this.leases.set(u, {
                ...
                ...(r.activeTabId === u ? { isActiveHandoff: !0 } : {}),
              }),
              (d = !0));
          }
          return d;
    ...
    async resumeHandoffTabs(e, a, s) {
      await this.ensureInit();
      const r = await this.getInstanceId(),
        i = new Set(s);
      if (i.size === 0) return [];
      const o = [];
      return (
    ...
    async releaseTabs(e, a) {
      ...
      s.size !== 0 &&
        (await this.mutate(() => {
          let r = !1;
          for (const i of s)
            this.leases.get(i)?.sessionId === e &&
              (this.leases.delete(i), (r = !0));
          return r;
        }));
    }
    async releaseActiveTurn(e, a) {
      (await this.ensureInit(),
        await this.mutate(() => {
          let s = !1;
          for (const [r, i] of this.leases.entries())
            i.sessionId !== e ||
              i.turnId !== a ||
              i.state !== "active" ||
              (this.leases.delete(r), (s = !0));
          return s;
        }));
    }
    ...
    async replaceTab(e, a) {
      (await this.ensureInit(),
        await this.mutate(() => {
          ...
          return s == null
            ? !1
            : (this.leases.delete(a),
              this.leases.set(e, { ...s, tabId: e }),
              !0);
        }));
    }
    async loadFromStorage() {
      const e = this.readActiveTabIds(),
        a = await this.storage.get(this.storageKey);
      for (const [s, r] of Vr(a[this.storageKey])) this.leases.set(s, r);
      ((this.storageLoaded = !0), this.publishActiveTabLeaseChanges(e));
    }
    async getInstanceId() {
      return (
        this.instanceIdPromise ||
          (this.instanceIdPromise = this.loadInstanceId()),
        await this.instanceIdPromise
      );
    }
    async loadInstanceId() {
      const e = (await this.instanceStorage.get("extensionInstanceId"))
        .extensionInstanceId;
    ...
    async mutate(e) {
      const a = async () => {
          ...
          (await e()) &&
            (await this.saveToStorage(), this.publishActiveTabLeaseChanges(r));
        },
    ...
    publishActiveTabLeaseChanges(e) {
      ...
      if (a.length !== 0)
        for (const s of this.activeTabLeaseChangeHandlers)
          Promise.resolve(s(a)).catch(() => {});
    }
  };
  function Gr(t, e) {
    const a = new Set();
    ...
    Ta = class re {
      ...
      handleWindowFocused = (e) => {
        e !== chrome.windows.WINDOW_ID_NONE &&
          this.clearFocusedWindowFinalizedBadge(e);
      };
      handleTabUpdated = (e, a) => {
        const s = a.favIconUrl,
          r = s != null,
          i = typeof s == "string" && ya(s);
        if (
          ((a.url != null || (r && !i)) && this.faviconDataUrls.delete(e),
          a.status === "complete" || (r && !i))
        ) {
      ...
      handleTabReplaced = (e, a) => {
        (this.faviconDataUrls.delete(a),
          this.faviconDataUrls.delete(e),
          this.replaceFinalizedBadge(e, a));
      };
      ...
      constructor(e = chrome.storage.session) {
        ((this.storage = e),
          (this.unsubscribeActiveTabLeaseChanges =
            this.tabLeases.subscribeActiveTabLeaseChanges(
              this.handleActiveTabLeaseChanges,
            )),
          this.registerEventListeners(),
        ...
        (await this.ensureInit(),
          await this.runStateOperation(async () => {
            ...
            await this.updateUnseenFinalizedBadges(() =>
              s
                ? this.unseenFinalizedBadges.get(e) === a
                  ? !1
                  : (this.unseenFinalizedBadges.set(e, a), !0)
                : this.unseenFinalizedBadges.delete(e),
            );
          }),
      ...
      dispose() {
        (this.listenersRegistered &&
          ...
          this.unsubscribeActiveTabLeaseChanges?.(),
          (this.unsubscribeActiveTabLeaseChanges = null),
          re.instance === this && (re.instance = null));
      }
      registerEventListeners() {
        this.listenersRegistered ||
          ((this.listenersRegistered = !0),
          ...
          chrome.tabs.onRemoved?.addListener(this.handleTabRemoved),
          chrome.tabs.onReplaced?.addListener(this.handleTabReplaced),
          chrome.windows.onFocusChanged?.addListener(this.handleWindowFocused));
      }
      async clearFinalizedBadge(e) {
        await this.ensureInit();
        let a = !1;
        (await this.runStateOperation(async () => {
          this.unseenFinalizedBadges.has(e) &&
            (await this.updateUnseenFinalizedBadges(
              () => (a = this.unseenFinalizedBadges.delete(e)),
            ));
        }),
      ...
      async clearFocusedWindowFinalizedBadge(e) {
        ...
        let a;
        try {
          a = await chrome.tabs.query({ active: !0, windowId: e });
        } catch {
          return;
        }
      ...
      async replaceFinalizedBadge(e, a) {
        ...
        (await this.runStateOperation(async () => {
          await this.updateUnseenFinalizedBadges(() => {
            ...
            return r == null
              ? !1
              : (this.unseenFinalizedBadges.delete(a),
                this.unseenFinalizedBadges.set(e, r),
                (s = r),
                !0);
          });
        }),
      ...
      async reconcileActiveTabLeaseChanges(e) {
        ...
        await this.runStateOperation(async () => {
          let s = !1;
          for (const r of a)
            (await this.tabLeases.getOwningSessionId(r)) != null &&
              (s = this.unseenFinalizedBadges.delete(r) || s);
      ...
      async readEffectiveBadge(e) {
        return (await this.tabLeases.getOwningSessionId(e)) != null
          ? "active"
          : (this.unseenFinalizedBadges.get(e) ?? null);
      }
      mightHaveBadge(e) {
        return (
          this.unseenFinalizedBadges.has(e) ||
          this.tabLeases.mightHaveActiveTabLease(e)
        );
      }
      async tabIsVisible(e) {
        try {
          const a = await chrome.tabs.get(e);
          return a.active !== !0 || typeof a.windowId != "number"
            ? !1
            : (await chrome.windows.get(a.windowId)).focused === !0;
        } catch {
          return !1;
        }
      }
      async loadFromStorage() {
        ...
        for (const [s, r] of Object.entries(e.badges)) {
          ...
          !Number.isInteger(i) ||
            !Hr(r) ||
            (this.unseenFinalizedBadges.set(i, r), a.push(i));
        }
        for (const s of a) this.scheduleReconcileTab(s);
      }
      ...
      async publishBadge(e, a) {
        const [s, r] = await Promise.all([
          va(e),
          a == null ? Promise.resolve(null) : this.readFaviconDataUrl(e),
        ]);
        if (!s) return;
        const i =
          a == null || r == null
            ? { type: "TAB_FAVICON_BADGE", badge: null, faviconDataUrl: null }
            : { type: "TAB_FAVICON_BADGE", badge: a, faviconDataUrl: r };
        try {
      ...
      async readFaviconDataUrl(e) {
        ...
        if (
          typeof a.favIconUrl != "string" ||
          a.favIconUrl.length === 0 ||
          ya(a.favIconUrl)
        )
          return null;
        ...
        return (
          r != null &&
            this.faviconDataUrls.set(e, { dataUrl: r, pageUrl: a.url }),
          r
        );
      }
    };
  ...
  async function Kr(t) {
    ...
    return (
      ...
      await Qr(e.toString(), "image/bmp")
    );
  }
  async function Qr(t, e) {
    const a = new AbortController(),
      s = setTimeout(() => a.abort(), Wr);
    try {
  ...
  async function Yr(t) {
    ...
    if (a != null && Number.isFinite(a) && a > Tt)
      return (await t.body?.cancel(), null);
    if (t.body == null) {
  ...
  function Xr(t) {
    ...
    for (let s = 0; s < t.length; s += 32768)
      e += String.fromCharCode(...t.subarray(s, s + 32768));
    return btoa(e);
  }
  var Ue = [
    "grey",
  ...
  var Jr = class be {
      ...
      async ensureAgentTabGroup(e, a, s) {
        ...
        if (r) {
          ...
          return (
            await this.addTabToGroup(r, a),
            await this.reconcileGroupPresentation(r.chromeGroupId),
        ...
        return (
          await this.reconcileGroupPresentation(i.chromeGroupId),
      ...
      async releaseTabsFromManagedGroups(e) {
        ...
        const s = await Promise.all(
            [...a].map(async (d) => {
              try {
                ...
                return typeof u.groupId != "number" ||
                  !this.groupMetadata.has(u.groupId)
                  ? null
                  : { groupId: u.groupId, tabId: d };
              } catch {
                return null;
              }
            }),
        ...
        r.length > 0 &&
          ...
          (await Promise.allSettled(
            r.map(async (d) => await chrome.tabs.ungroup(d)),
          ));
        let o = !1;
      ...
      async refreshManagedGroupsFromChrome() {
        await this.ensureInit();
        let e = !1;
        for (const a of Array.from(this.groupMetadata.keys()))
          e = (await this.removeManagedGroupIfEmpty(a)) || e;
        e && (await this.saveToStorage());
      }
      async getManagedGroupIdContainingTabs(e) {
        return (
          await this.ensureInit(),
          (await this.findManagedGroupContainingTabs(e))?.chromeGroupId ?? null
        );
      }
      async reconcileManagedGroupForTabs(e, a, s) {
        ...
        if (
          !r ||
          !(await this.readGroup(a)) ||
          !(await this.hasTabInGroup(a, s))
        )
          return !1;
        const i = this.syncSessionTitle(r, e);
        return (
          await this.reconcileGroupPresentation(a),
          i && (await this.saveToStorage()),
          !0
        );
      }
      async setSessionGroupTitle(e, a, s) {
        ...
        r
          ? this.sessionGroupTitles.set(e, r)
          : this.sessionGroupTitles.delete(e);
        const o = await this.findManagedGroupContainingTabs(s);
        (o &&
          ((i = this.syncSessionTitle(o, e) || i),
          await this.reconcileGroupPresentation(o.chromeGroupId)),
          i && (await this.saveToStorage()));
      }
      async loadFromStorage() {
        const e = (await chrome.storage.local.get(this.storageKey))[
          this.storageKey
        ];
        if (e) {
          if (Array.isArray(e)) {
            for (const a of e)
              !a ||
                typeof a.chromeGroupId != "number" ||
                this.groupMetadata.set(a.chromeGroupId, {
                  chromeGroupId: a.chromeGroupId,
                  presentationColor: St(a.presentationColor)
                    ? a.presentationColor
                    : void 0,
                  title: pe(a.title),
                });
      ...
      async createGroup(e, a) {
        const s = await chrome.tabs.group({ tabIds: [e] }),
          r = { chromeGroupId: s, presentationColor: Sa(), title: pe(a) };
        return (this.groupMetadata.set(s, r), r);
      }
      async addTabToGroup(e, a) {
        (await chrome.tabs.get(a)).groupId !== e.chromeGroupId &&
          (await chrome.tabs.group({ groupId: e.chromeGroupId, tabIds: a }));
      }
      registerEventListeners() {
        this.listenersRegistered ||
          !chrome.tabGroups ||
      ...
      async handleObservedGroup(e) {
        this.groupMetadata.has(e.id) &&
          (await this.reconcileGroupPresentation(e.id, e));
      }
      ...
      async reconcileAllGroupPresentations() {
        await Promise.all(
          Array.from(this.groupMetadata.keys(), (e) =>
            this.reconcileGroupPresentation(e),
          ),
        );
      }
      async reconcileGroupPresentation(e, a) {
        ...
        if (!s) return;
        const r = s.presentationColor,
          i = this.ensurePresentationColor(s);
        if (
          (r !== i && (await this.saveToStorage()),
          !chrome.tabGroups?.update ||
            this.groupIdsReconcilingPresentation.has(e))
        )
          return;
        const o = s.title ?? this.defaultSessionGroupTitle,
          d = a ?? (await this.readGroup(e)),
          u = {};
        if (
          ((!d || d.color !== i) && (u.color = i),
          (!d || d.collapsed !== !1) && (u.collapsed = !1),
          (!d || d.title !== o) && (u.title = o),
      ...
      syncSessionTitle(e, a) {
        ...
        return e.title === s ? !1 : ((e.title = s), !0);
      }
      async removeManagedGroupIfEmpty(e) {
        return (await this.groupTabIds(e)).length > 0
          ? !1
          : (this.groupMetadata.delete(e), !0);
      }
      async groupTabIds(e) {
        return (await chrome.tabs.query({ groupId: e }))
          .map((a) => a.id)
      ...
      async hasTabInGroup(e, a) {
        for (const s of a)
          try {
            if ((await chrome.tabs.get(s)).groupId === e) return !0;
          } catch {}
        return !1;
      }
    },
  ...
  function rn() {
    Ia ||
      (chrome.debugger.onDetach.addListener((t) => {
        (typeof t.tabId == "number" && se.delete(t.tabId),
          typeof t.targetId == "string" &&
            (Ze.delete(t.targetId), Fe.delete(t.targetId)));
      }),
      (Ia = !0));
  }
  var nn = class {
    ...
    async claimUserTab(t) {
      return await this.resolveSession(t).claimUserTab(
        this.requireTurnId(t),
        t.tabId,
      );
    }
    async createTab(t) {
    ...
    async finalizeTabs(t) {
      const e = this.resolveSession(t),
        a = this.requireTurnId(t);
      if (!Array.isArray(t.keep))
    ...
    async moveMouse(t) {
      ...
      await (
        await this.activateSession(t)
      ).requireSessionTab(t.tabId, { publishOverlay: !1, trackOverlay: !0 });
      const a = this.nextCursorMoveSequence;
      this.nextCursorMoveSequence += 1;
      const s = t.waitForArrival === !1 || !e ? !1 : await kn(t.tabId),
        r =
          t.waitForArrival !== !1 && s
    ...
    notifyCursorArrived({ moveSequence: t, sessionId: e, turnId: a }) {
      Number.isInteger(t) &&
        this.cursorArrivalWaitersByKey.get(xa(e, a, t))?.();
    }
    async turnEnded(t) {
    ...
    async getInfo(t) {
      return (
          ...
          ).extensionInstanceId),
        {
          ...
          type: "extension",
          capabilities: { tab: [en, ...(this.isWebMcpEnabled() ? [sa] : [])] },
          metadata: {
    ...
    addDownloadChangeListener(t) {
      return (
        this.downloadChangeListeners.add(t),
        () => {
    ...
    handleDownloadCreated(t) {
      Oa(t.id) &&
        Z.isBrowserControlActive() &&
        typeof t.filename == "string" &&
        (this.downloadFilenamesById.set(t.id, t.filename),
        this.downloadUrlsById.set(t.id, t.finalUrl),
    ...
    createCursorArrivalWaiter({ moveSequence: t, sessionId: e, turnId: a }) {
      ...
      const o = () => {
        (r != null && (clearTimeout(r), (r = null)),
          this.cursorArrivalWaitersByKey.delete(s),
          i?.());
      };
      return {
        cancel: o,
        promise: new Promise((d) => {
          ((i = d),
            (r = setTimeout(o, tn)),
            this.cursorArrivalWaitersByKey.set(s, o));
        }),
      };
    }
  ...
  var on = class {
    ...
    async activateTurn(t) {
      this.currentTurnId !== t &&
        (await this.runTurnMutation(t, async () => {}));
    }
    async executeCdp(t) {
      const e = t.target.tabId;
      if (typeof e == "number" && (await this.requireSessionTab(e), !se.has(e)))
    ...
    async createTab(t) {
      return await this.runTurnMutation(t, async () => {
        const e = await this.activeAgentTabIds(),
          a = await fn();
        return (
          (this.activeTabId = a.id),
          await this.tabGroups.ensureAgentTabGroup(this.sessionId, a.id, e),
          await this.tabLeases.claimTab(this.sessionId, t, a.id, "agent"),
          await this.requireSessionTab(a.id, { trackOverlay: !0 }),
          { ...a, active: !0 }
        );
      });
    }
      ...
      return await this.runTurnMutation(t, async () => {
        ...
        return (
          ...
          s === this.sessionId
            ? (await this.requireSessionTab(a.id, { trackOverlay: !0 }),
              { ...qe(a), active: !0 })
            : (await this.tabLeases.claimTab(this.sessionId, t, a.id, "user"),
              await this.requireSessionTab(a.id, { trackOverlay: !0 }),
              { ...qe(a), active: !0 })
        );
      });
    ...
    async finalizeTabs(t, e) {
      await this.runTurnMutation(t, async () => {
        const a = await this.listSessionTabs(),
          s = Rn(e, new Set(a.map((_) => _.id))),
          r = await this.tabLeases.getSessionActiveLeases(this.sessionId),
          i = [],
          o = [],
          d = [],
          u = [];
        ...
        if (
          (await Promise.all([
            Promise.all([
              ...o.map(async (_) =>
                this.tabFavicons
                  .markFinalized(_, "deliverable")
                  .catch(() => {}),
              ),
              ...i.map(async (_) =>
                this.tabFavicons.markFinalized(_, "handoff").catch(() => {}),
              ),
            ]),
            this.detachAttachedDebuggersBestEffort(l),
          ]),
          await this.tabGroups.releaseTabsFromManagedGroups(o),
          d.length > 0 &&
            (await Pn(d),
            await this.tabGroups.refreshManagedGroupsFromChrome()),
          await Promise.all(
            l.map(async (_) => Z.untrackTab(this.sessionId, _)),
          ),
          await this.tabLeases.releaseTabs(this.sessionId, [...o, ...d, ...u]),
          i.length > 0)
        ) {
          const _ = i.filter((J) => r.get(J)?.origin === "agent"),
            P = await this.tabGroups.getManagedGroupIdContainingTabs(_);
          await this.tabLeases.handoffTabs(this.sessionId, t, i, {
    ...
    async endTurn(t) {
      await this.runLifecycle(async () => {
        ...
        (await this.detachAttachedDebuggersBestEffort(e.map((a) => a.id)),
          await Z.stopSessions([this.sessionId]),
          await this.tabLeases.releaseActiveTurn(this.sessionId, t),
          (this.activeTabId = null),
    ...
    async resumeHandoffIfPresent(t) {
      ...
      const a = await Promise.all(
        ...
        r = [];
      for (const l of a)
        l.state === "reclaimed" ? s.push(l.tabId) : r.push(l.tabId);
      if (
        (r.length > 0 && (await this.tabLeases.releaseTabs(this.sessionId, r)),
        s.length === 0)
      )
        return;
      ...
      const o = new Set(i),
        d = [...e.values()].find(
          (l) => o.has(l.tabId) && l.groupId != null,
        )?.groupId;
      d != null &&
      ...
      const u = [...e.values()].find(
        (l) => l.isActiveHandoff === !0 && o.has(l.tabId),
      )?.tabId;
    ...
    async detachAttachedDebuggersBestEffort(t) {
      const e = new Set(t);
      await Promise.allSettled([
        ...[...e].filter((a) => se.has(a)).map(async (a) => ka(a)),
    ...
    async listSessionTabs() {
      const t = (await this.tabLeases.getSessionTabs(this.sessionId)).filter(
        (e) => e.id !== void 0 && !e.url?.startsWith("chrome://"),
      );
    ...
    async activeAgentTabIds() {
      return [
        ...(
          await this.tabLeases.getSessionActiveLeases(this.sessionId)
        ).values(),
      ]
    ...
    tabInfosWithLogicalActive(t) {
      const e = t.map(qe),
        a = this.resolveLogicalActiveTabId(e);
      return a == null
        ? e
        : e.map((s) =>
            s.active === (s.id === a) ? s : { ...s, active: s.id === a },
          );
    }
    resolveLogicalActiveTabId(t) {
      return t.length === 0
        ? null
        : this.activeTabId != null && t.some((e) => e.id === this.activeTabId)
          ? this.activeTabId
          : ((this.activeTabId =
              t.find((e) => e.active)?.id ?? t[0]?.id ?? null),
            this.activeTabId);
    }
    async requireSessionTab(t, e = {}) {
      if (await this.tabLeases.isClaimedBySession(this.sessionId, t)) {
        const a = e.trackOverlay === !0 && e.publishOverlay !== !1;
        (await Z.startSession(this.sessionId, this.currentTurnId, {
          publishTabs: a,
        }),
          e.trackOverlay === !0 &&
            (await Z.trackTab(this.sessionId, t, { publish: a })));
        return;
      }
      throw new Error(
        `Tab ${t} is not part of browser session ${this.sessionId}`,
      );
    }
    async runLifecycle(t) {
      const e = this.lifecycleQueue.then(t, t);
      return (
        (this.lifecycleQueue = e.then(
          () => {},
          () => {},
        )),
        await e
    ...
    async runTurnMutation(t, e) {
      return await this.runLifecycle(
        async () => (
          this.currentTurnId !== t &&
            (await this.resumeHandoffIfPresent(t),
            await this.tabLeases.updateActiveSessionTurn(this.sessionId, t),
            (this.currentTurnId = t)),
          await e()
        ),
      );
  ...
  async function un(t) {
    ...
    e != null &&
      (await La({
        ...
        commandParams: { ...e, deviceScaleFactor: 1, mobile: !1 },
      }));
  }
  function ln(t) {
    ...
    return e?.groups == null
      ? null
      : {
          width: Number.parseInt(e.groups.width, 10),
          height: Number.parseInt(e.groups.height, 10),
        };
  }
  async function ka(t) {
    await xt(t, async () => {
  ...
  async function mn() {
    const t = await chrome.windows.getAll({ windowTypes: ["normal"] }),
      e = t.find((a) => a.focused && a.id !== void 0);
    return e?.id !== void 0
      ? e.id
      : (t.find((a) => a.id !== void 0)?.id ?? null);
  }
  async function pn() {
  ...
  async function vn() {
    const t = (await chrome.tabs.query({})).filter(ze).sort(Sn).slice(0, sn),
      e = await Tn(t);
    return t.map((a) => In(a, e));
  }
  async function gn(t) {
    const e = { text: yn(t.query), maxResults: bn(t.limit) },
      a = Pa(t.from, "from") ?? 0,
      s = Pa(t.to, "to");
    return (
      (e.startTime = a),
      s != null && (e.endTime = s),
      (await chrome.history.search(e)).flatMap(wn)
    );
  }
  function yn(t) {
    if (t == null) return "";
  ...
  function Pa(t, e) {
    if (t != null) {
      if (typeof t != "string")
        throw new Error(`getUserHistory requires ${e} to be a valid date`);
      return _n(t, e);
    }
  }
  function wn(t) {
    const e = t.url,
      a = t.lastVisitTime;
    return typeof e != "string" || typeof a != "number" || !Number.isFinite(a)
      ? []
      : [
          {
            url: e,
            ...(t.title == null ? {} : { title: t.title }),
            dateVisited: new Date(a).toISOString(),
          },
        ];
  }
  function _n(t, e) {
  ...
  async function Tn(t) {
    const e = new Set();
    for (const s of t)
      typeof s.groupId == "number" && s.groupId !== -1 && e.add(s.groupId);
    const a = await Promise.all(
      [...e].map(async (s) => {
        try {
  ...
  function In(t, e) {
    const a = It(t),
      s = typeof t.groupId == "number" ? e.get(t.groupId) : void 0;
    return {
      id: t.id,
      ...(t.title == null ? {} : { title: t.title }),
      ...(t.url == null ? {} : { url: t.url }),
      ...(a <= 0 ? {} : { lastOpened: new Date(a).toISOString() }),
      ...(s == null ? {} : { tabGroup: s }),
    };
  }
  ...
  function xn(t, e) {
    if (($a(t, e.tabId), !Number.isFinite(e.x) || !Number.isFinite(e.y)))
      throw new Error(`${t} requires finite x and y coordinates`);
  }
  async function kn(t) {
    let e;
    try {
    ...
    if (e.active !== !0 || typeof e.windowId != "number") return !1;
    try {
  ...
  function Rn(t, e) {
    ...
    for (const s of t) {
      ...
      if (($a("finalizeTabs", r), !e.has(r)))
        throw new Error(`finalizeTabs cannot keep unknown tab ${r}`);
  ...
  function La(t) {
    if (t.method === "Target.getTargets")
      return chrome.debugger.getTargets().then((a) => ({ targetInfos: a }));
    const e =
      typeof t.target.targetId == "string"
        ? { targetId: t.target.targetId }
        : t.target;
  ...
  var Na = class extends Error {
    constructor(t, e) {
      (super(`Timed out after ${e}ms waiting for CDP command ${t}.`),
  ...
  var Ln = "native-transport-reconnect",
    kt = 5e3,
    Nn = 3e4 / 6e4,
    Bn = class {
      port = null;
      ...
      requestHost(t, e) {
        ...
        const s = this.createHostRequestId(),
          r = {
            jsonrpc: "2.0",
            id: s,
            method: t,
        ...
        return new Promise((i, o) => {
          ...
          try {
            ...
            (this.pendingHostRequests.delete(s),
              o(d instanceof Error ? d : new Error(String(d))));
          }
        });
      }
      ...
      connect(t = {}) {
        ...
        try {
          ...
          const s = a instanceof Error ? a.message : String(a),
            r = t.failureState ?? "disconnected";
          return (
            this.updateStatus(r, {
              error: s,
              ...(r === "reconnecting" ? { nextRetryMs: kt } : {}),
            }),
            !1
          );
        }
        return (
          ...
          e.onMessage.addListener((a) => {
            this.port === e &&
              ((this.reconnectAttempt = 0),
              this.updateStatus("connected"),
              !this.handleHostResponse(a) && this.messageCallback?.(a));
          }),
          e.onDisconnect.addListener(() => {
            ...
            (this.updateStatus("disconnected", { error: a.lastError?.message }),
              this.scheduleReconnect());
          }),
          !0
        );
      ...
      createHostRequestId() {
        return (
          ...
          `native-host:${this.nextHostRequestId}`
        );
      }
      handleHostResponse(t) {
        if (!("id" in t)) return !1;
        const e = String(t.id),
          a = this.pendingHostRequests.get(e);
        return a
          ? (this.pendingHostRequests.delete(e),
            "error" in t
              ? a.reject(new Error(t.error.message))
              : "result" in t
                ? a.resolve(t.result)
                : a.reject(
                    new Error("Native host returned an invalid response"),
                  ),
            !0)
          : !1;
      }
      ...
      updateStatus(t, e = {}) {
        ((this.status = {
          ...
          ...(e.nextRetryMs ? { nextRetryMs: e.nextRetryMs } : {}),
        }),
          this.onStatusChange?.(this.getStatus()));
      }
    },
    Ve = "codexPendingUpdateVersion",
    Un = class {
      ...
      storage;
      constructor(t, e = {}) {
        ((this.currentVersion = e.currentVersion ?? null),
          (this.isInUse = t),
          (this.onUpdateAvailable =
            e.onUpdateAvailable ?? chrome.runtime.onUpdateAvailable),
          (this.reload = e.reload ?? (() => chrome.runtime.reload())),
          (this.storage = e.storage ?? chrome.storage.session));
      }
      register() {
      ...
      async maybeReloadForPendingUpdate() {
        if (
          ...
          try {
            ...
            throw ((this.reloadInProgress = !1), t);
          }
        }
      }
      async handleUpdateAvailable(t) {
        (await this.storage.set({ [Ve]: t.version }),
          (this.pendingUpdateVersion = t.version),
  ...
  async function Zn(t) {
    ((await chrome.alarms.get(Ct)) ||
      (await chrome.alarms.create(Ct, { periodInMinutes: 0.5 })),
      chrome.alarms.onAlarm.addListener(async (e) => {
        if (e.name !== Ct) return;
        try {
          const s = new Promise((r) => setTimeout(() => r(!1), 3e3));
        ...
        await Promise.allSettled(
          a
            .filter((s) => typeof s.tabId == "number")
            .map((s) =>
              chrome.debugger.detach({ tabId: s.tabId }).catch(() => {}),
            ),
        );
      }));
  }
  var hd = "open-codex-side-panel",
    Fn = [
      "alarms",
      "bookmarks",
      "debugger",
    ...
    jn = ["sidePanel"],
    fd = [...Fn, ...jn],
    At = "codexSidePanelOpenWindowIds";
  function Dn(t) {
    return Array.isArray(t)
      ? new Set(
          t.filter((e) => typeof e == "number" && Number.isSafeInteger(e)),
        )
      : new Set();
  }
  var X = new Set(),
  ...
  function Vn() {
    Ba ||
      (chrome.sidePanel.onOpened?.addListener((t) => {
        Ge(t.windowId, !0).catch(() => {});
      }),
      chrome.sidePanel.onClosed?.addListener((t) => {
        Ge(t.windowId, !1).catch(() => {});
      }),
      (Ba = !0));
  }
  async function Gn(t) {
    ...
    (await chrome.sidePanel.open({ windowId: e }), await Ge(e, !0));
  }
  function Wn(t, e, a, s) {
    if (e?.type === "ensure_codex_app_server") {
      ...
      return (
        (async () => {
          ...
          try {
            const i = await t.requestHost("ensureCodexAppServer"),
              o = t.refreshStatus();
            (s(o), a({ ok: !0, nativeHostStatus: o, sidePanelOpen: !0, ...i }));
          } catch (i) {
    ...
    if (e?.type === "GET_NATIVE_HOST_STATUS") {
      ...
      return (
        s(r),
        a({ ok: r.state === "connected", status: r, error: r.error }),
        !0
      );
    }
    return !1;
  ...
  async function Jn() {
    const t = Xn[Zt("prod")],
      e = new Un(() => Z.isBrowserControlActive()),
      a = new nn();
    (e.register(),
      Z.setBrowserControlActivityChangeHandler((i) => {
    ...
    (Rt(s.getStatus()),
      ...
      Wa() && zn());
    const r = new Sr(s, a);
    (chrome.runtime.onMessage.addListener((i, o, d) =>
      Wn(s, i, d, Rt) ? !0 : ei(a, i, o, d),
    ),
      chrome.debugger.onEvent.addListener((i, o, d) => {
    ...
    switch (e?.type) {
      case "GET_AGENT_CURSOR_STATE":
        return typeof r != "number"
          ? (s({ ok: !0, state: Z.readCursorOverlayState(-1) }), !0)
          : (s({ ok: !0, state: Z.readCursorOverlayState(r) }), !0);
      case "AGENT_CURSOR_ARRIVED":
        return typeof r != "number" ||
          ...
          typeof e.sessionId != "string" ||
          typeof e.turnId != "string" ||
          !Number.isInteger(e.moveSequence)
          ? (s({ ok: !1 }), !0)
          : (t.notifyCursorArrived({
              moveSequence: e.moveSequence,
              sessionId: e.sessionId,
              turnId: e.turnId,
            }),
            s({ ok: !0 }),
  ...
  var Ua = class {
      constructor(t) {
        if (t === "<all_urls>")
          ((this.isAllUrls = !0),
            (this.protocolMatches = [...Ua.PROTOCOLS]),
            (this.hostnameMatch = "*"),
            (this.pathnameMatch = "*"));
        else {
          const e = /(.*):\/\/(.*?)(\/.*)/.exec(t);
          ...
          (si(t, s),
            ri(t, r),
            (this.protocolMatches = s === "*" ? ["http", "https"] : [s]),
      ...
      isHostPathMatch(t) {
        ...
        const e = [
          ...
          a = this.convertPatternToRegex(this.pathnameMatch);
  ...
  function si(t, e) {
    if (!Pt.PROTOCOLS.includes(e) && e !== "*")
      throw new We(t, `${e} not a valid protocol (${Pt.PROTOCOLS.join(", ")})`);
  }
  function ri(t, e) {
  ...
  function He(t, ...e) {}
  var ni = {
      debug: (...t) => He(console.debug, ...t),
      log: (...t) => He(console.log, ...t),
      warn: (...t) => He(console.warn, ...t),
      error: (...t) => He(console.error, ...t),
    },
    Et;
  try {
    ((Et = ai.main()),
